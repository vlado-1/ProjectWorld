...
initSqlJs({ locateFile: (file: string) => dbConfig.assemblyFile }).then((SQL) => {
  ...
  const CreateDataQuery: string = `INSERT INTO projects VALUES 
      ...
      ( -30, 120, 'Website Development', 'Developed this dynamic website using Angular and SQLite.', 'assets/images/Angular_Country.png', 'https://www.youtube.com/embed/TuaDNw67W_0?si=W_2BKLN6S7d2_7t1' ),
